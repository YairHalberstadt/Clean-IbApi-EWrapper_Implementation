    ...
    public class IBReceiver : EWrapper
    {
        ...
        public virtual void currentTime(long time)
        {
            lock (CurrentTimeLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new CurrentTimeArgs(time), null, null);
                }
            }
        }
        ...
        public virtual void tickPrice(int tickerId, int field, double price, int canAutoExecute)
        {
            lock (TickPriceLock)
            {
                if (TickPriceSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new TickPriceArgs(tickerId, field, price, canAutoExecute), null, null);
                    }
                }
            }
        }
        ...
        public virtual void tickSize(int tickerId, int field, int size)
        {
            lock (TickSizeLock)
            {
                if (TickSizeSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new TickSizeArgs(tickerId, field, size), null, null);
                    }
                }
            }
        }
        ...
        public virtual void tickString(int tickerId, int field, string value)
        {
            lock (TickStringLock)
            {
                if (TickStringSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new TickStringArgs(tickerId, field, value), null, null);
                    }
                }
            }
        }
        ...
        public virtual void tickGeneric(int tickerId, int field, double value)
        {
            lock (TickGenericLock)
            {
                if (TickGenericSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new TickGenericArgs(tickerId, field, value), null, null);
                    }
                }
            }
        }
        ...
        public virtual void tickEFP(int tickerId, int tickType, double basisPoints, string formattedBasisPoints, double impliedFuture, int holdDays, string futureLastTradeDate, double dividendImpact, double dividendsToLastTradeDate)
        {
            lock (TickEfpLock)
            {
                if (TickEfpSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new TickEfpArgs(tickerId, tickType, basisPoints, formattedBasisPoints, impliedFuture, holdDays, futureLastTradeDate, dividendImpact, dividendsToLastTradeDate), null, null);
                    }
                }
            }
        }
        ...
        public virtual void deltaNeutralValidation(int reqId, UnderComp underComp)
        {
            lock (DeltaNeutralValidationLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new DeltaNeutralValidationArgs(reqId, underComp), null, null);
                }
            }
        }
        ...
        public virtual void tickOptionComputation(int tickerId, int field, double impliedVolatility, double delta, double optPrice, double pvDividend, double gamma, double vega, double theta, double undPrice)
        {
            lock (TickOptionComputationLock)
            {
                if (TickOptionComputationSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new TickOptionComputationArgs(tickerId, field, impliedVolatility, delta, optPrice, pvDividend, gamma, vega, theta, undPrice), null, null);
                    }
                }
            }
        }
        ...
        public virtual void tickSnapshotEnd(int tickerId)
        {
            lock (TickSnapshotEndLock)
            {
                if (TickSnapshotEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new TickSnapshotEndArgs(tickerId), null, null);
                    }
                }
            }
        }
        ...
        public virtual void managedAccounts(string accountsList)
        {
            lock (ManagedAccountsLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new ManagedAccountsArgs(accountsList), null, null);
                }
            }
        }
        ...
        public virtual void connectionClosed()
        {
            lock (ConnectionClosedLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new ConnectionClosedArgs(), null, null);
                }
            }
        }
        ...
        public virtual void accountSummary(int reqId, string account, string tag, string value, string currency)
        {
            lock (AccountSummaryLock)
            {
                if (AccountSummarySubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new AccountSummaryArgs(reqId, account, tag, value, currency), null, null);
                    }
                }
            }
        }
        ...
        public virtual void accountSummaryEnd(int reqId)
        {
            lock (AccountSummaryEndLock)
            {
                if (AccountSummaryEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new AccountSummaryEndArgs(reqId), null, null);
                    }
                }
            }
        }
        ...
        public virtual void bondContractDetails(int reqId, ContractDetails contract)
        {
            lock (BondContractDetailsLock)
            {
                if (BondContractDetailsSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new BondContractDetailsArgs(reqId, contract), null, null);
                    }
                }
            }
        }
        ...
        public virtual void updateAccountValue(string key, string value, string currency, string accountName)
        {
            lock (UpdateAccountValueLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new UpdateAccountValueArgs(key, value, currency, accountName), null, null);
                }
            }
        }
        ...
        public virtual void updatePortfolio(Contract contract, double position, double marketPrice, double marketValue, double averageCost, double unrealisedPNL, double realisedPNL, string accountName)
        {
            lock (UpdatePortfolioLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new UpdatePortfolioArgs(contract, position, marketPrice, marketValue, averageCost, unrealisedPNL, realisedPNL, accountName), null, null);
                }
            }
        }
        ...
        public virtual void updateAccountTime(string timestamp)
        {
            lock (UpdateAccountTimeLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new UpdateAccountTimeArgs(timestamp), null, null);
                }
            }
        }
        ...
        public virtual void accountDownloadEnd(string account)
        {
            lock (AccountDownloadEndLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new AccountDownloadEndArgs(account), null, null);
                }
            }
        }
        ...
        public virtual void orderStatus(int orderId, string status, double filled, double remaining, double avgFillPrice, int permId, int parentId, double lastFillPrice, int clientId, string whyHeld)
        {
            lock (OrderStatusLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new OrderStatusArgs(orderId, status, filled, remaining, avgFillPrice, permId, parentId, lastFillPrice, clientId, whyHeld), null, null);
                }
            }
        }
        ...
        public virtual void openOrder(int orderId, Contract contract, Order order, OrderState orderState)
        {
            lock (OpenOrderLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new OpenOrderArgs(orderId, contract, order, orderState), null, null);
                }
            }
        }
        ...
        public virtual void openOrderEnd()
        {
            lock (OpenOrderEndLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new OpenOrderEndArgs(), null, null);
                }
            }
        }
        ...
        public virtual void contractDetails(int reqId, ContractDetails contractDetails)
        {
            lock (ContractDetailsLock)
            {
                if (ContractDetailsSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new ContractDetailsArgs(reqId, contractDetails), null, null);
                    }
                }
            }
        }
        ...
        public virtual void contractDetailsEnd(int reqId)
        {
            lock (ContractDetailsEndLock)
            {
                if (ContractDetailsEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new ContractDetailsEndArgs(reqId), null, null);
                    }
                }
            }
        }
        ...
        public virtual void execDetails(int reqId, Contract contract, Execution execution)
        {
            lock (ExecDetailsLock)
            {
                if (ExecDetailsSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new ExecDetailsArgs(reqId, contract, execution), null, null);
                    }
                }
            }
        }
        ...
        public virtual void execDetailsEnd(int reqId)
        {
            lock (ExecDetailsEndLock)
            {
                if (ExecDetailsEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new ExecDetailsEndArgs(reqId), null, null);
                    }
                }
            }
        }
        ...
        public virtual void commissionReport(CommissionReport commissionReport)
        {
            lock (CommissionReportLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new CommissionReportArgs(commissionReport), null, null);
                }
            }
        }
        ...
        public virtual void fundamentalData(int reqId, string data)
        {
            lock (FundamentalDataLock)
            {
                if (FundamentalDataSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new FundamentalDataArgs(reqId, data), null, null);
                    }
                }
            }
        }
        ...
        public virtual void historicalData(int reqId, string date, double open, double high, double low, double close, int volume, int count, double WAP, bool hasGaps)
        {
            lock (HistoricalDataLock)
            {
                if (HistoricalDataSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new HistoricalDataArgs(reqId, date, open, high, low, close, volume, count, WAP, hasGaps), null, null);
                    }
                }
            }
        }
        ...
        public virtual void historicalDataEnd(int reqId, string start, string end)
        {
            lock (HistoricalDataEndLock)
            {
                if (HistoricalDataEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new HistoricalDataEndArgs(reqId, start, end), null, null);
                    }
                }
            }
        }
        ...
        public virtual void marketDataType(int reqId, int marketDataType)
        {
            lock (MarketDataTypeLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new MarketDataTypeArgs(reqId, marketDataType), null, null);
                }
            }
        }
        ...
        public virtual void updateMktDepth(int tickerId, int position, int operation, int side, double price, int size)
        {
            lock (UpdateMktDepthLock)
            {
                if (UpdateMktDepthSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new UpdateMktDepthArgs(tickerId, position, operation, side, price, size), null, null);
                    }
                }
            }
        }
        ...
        public virtual void updateMktDepthL2(int tickerId, int position, string marketMaker, int operation, int side, double price, int size)
        {
            lock (UpdateMktDepthL2Lock)
            {
                if (UpdateMktDepthL2SubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new UpdateMktDepthL2Args(tickerId, position, marketMaker, operation, side, price, size), null, null);
                    }
                }
            }
        }
        ...
        public virtual void updateNewsBulletin(int msgId, int msgType, string message, string origExchange)
        {
            lock (UpdateNewsBulletinLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new UpdateNewsBulletinArgs(msgId, msgType, message, origExchange), null, null);
                }
            }
        }
        ...
        public virtual void position(string account, Contract contract, double pos, double avgCost)
        {
            lock (PositionLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new PositionArgs(account, contract, pos, avgCost), null, null);
                }
            }
        }
        ...
        public virtual void positionEnd()
        {
            lock (PositionEndLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new PositionEndArgs(), null, null);
                }
            }
        }
        ...
        public virtual void realtimeBar(int reqId, long time, double open, double high, double low, double close, long volume, double WAP, int count)
        {
            lock (RealtimeBarLock)
            {
                if (RealtimeBarSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new RealtimeBarArgs(reqId, time, open, high, low, close, volume, WAP, count), null, null);
                    }
                }
            }
        }
        ...
        public virtual void scannerParameters(string xml)
        {
            lock (ScannerParametersLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new ScannerParametersArgs(xml), null, null);
                }
            }
        }
        ...
        public virtual void scannerData(int reqId, int rank, ContractDetails contractDetails, string distance, string benchmark, string projection, string legsStr)
        {
            lock (ScannerDataLock)
            {
                if (ScannerDataSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new ScannerDataArgs(reqId, rank, contractDetails, distance, benchmark, projection, legsStr), null, null);
                    }
                }
            }
        }
        ...
        public virtual void scannerDataEnd(int reqId)
        {
            lock (ScannerDataEndLock)
            {
                if (ScannerDataEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new ScannerDataEndArgs(reqId), null, null);
                    }
                }
            }
        }
        ...
        public virtual void receiveFA(int faDataType, string faXmlData)
        {
            lock (ReceiveFALock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new ReceiveFAArgs(faDataType, faXmlData), null, null);
                }
            }
        }
        ...
        public virtual void verifyMessageAPI(string apiData)
        {
            lock (VerifyMessageAPILock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new VerifyMessageAPIArgs(apiData), null, null);
                }
            }
        }
        ...
        public virtual void verifyCompleted(bool isSuccessful, string errorText)
        {
            lock (VerifyCompletedLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new VerifyCompletedArgs(isSuccessful, errorText), null, null);
                }
            }
        }
        ...
        public virtual void verifyAndAuthMessageAPI(string apiData, string xyzChallenge)
        {
            lock (VerifyAndAuthMessageAPILock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new VerifyAndAuthMessageAPIArgs(apiData, xyzChallenge), null, null);
                }
            }
        }
        ...
        public virtual void verifyAndAuthCompleted(bool isSuccessful, string errorText)
        {
            lock (VerifyAndAuthCompletedLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new VerifyAndAuthCompletedArgs(isSuccessful, errorText), null, null);
                }
            }
        }
        ...
        public virtual void displayGroupList(int reqId, string groups)
        {
            lock (DisplayGroupListLock)
            {
                if (DisplayGroupListSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new DisplayGroupListArgs(reqId, groups), null, null);
                    }
                }
            }
        }
        ...
        public virtual void displayGroupUpdated(int reqId, string contractInfo)
        {
            lock (DisplayGroupUpdatedLock)
            {
                if (DisplayGroupUpdatedSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new DisplayGroupUpdatedArgs(reqId, contractInfo), null, null);
                    }
                }
            }
        }
        ...
        public void connectAck()
        {
            lock (ConnectAckLock)
            {
                ...
                {
                    action.BeginInvoke(Wrapper, new ConnectAckArgs(), null, null);
                }
            }
        }
        ...
        public void positionMulti(int requestId, string account, string modelCode, Contract contract, double pos, double avgCost)
        {
            lock (PositionMultiLock)
            {
                if (PositionMultiSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new PositionMultiArgs(requestId, account, modelCode, contract, pos, avgCost), null, null);
                    }
                }
            }
        }
        ...
        public void positionMultiEnd(int requestId)
        {
            lock (PositionMultiEndLock)
            {
                if (PositionMultiEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new PositionMultiEndArgs(requestId), null, null);
                    }
                }
            }
        }
        ...
        public void accountUpdateMulti(int requestId, string account, string modelCode, string key, string value, string currency)
        {
            lock (AccountUpdateMultiLock)
            {
                if (AccountUpdateMultiSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new AccountUpdateMultiArgs(requestId, account, modelCode, key, value, currency), null, null);
                    }
                }
            }
        }
        ...
        public void accountUpdateMultiEnd(int requestId)
        {
            lock (AccountUpdateMultiEndLock)
            {
                if (AccountUpdateMultiEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new AccountUpdateMultiEndArgs(requestId), null, null);
                    }
                }
            }
        }
        ...
        public void securityDefinitionOptionParameter(int reqId, string exchange, int underlyingConId, string tradingClass, string multiplier, HashSet<string> expirations, HashSet<double> strikes)
        {
            lock (SecurityDefinitionOptionParameterLock)
            {
                if (SecurityDefinitionOptionParameterSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new SecurityDefinitionOptionParameterArgs(reqId, exchange, underlyingConId, tradingClass, multiplier, expirations, strikes), null, null);
                    }
                }
            }
        }
        ...
        public void securityDefinitionOptionParameterEnd(int reqId)
        {
            lock (SecurityDefinitionOptionParameterEndLock)
            {
                if (SecurityDefinitionOptionParameterEndSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new SecurityDefinitionOptionParameterEndArgs(reqId), null, null);
                    }
                }
            }
        }
        ...
        public void softDollarTiers(int reqId, SoftDollarTier[] tiers)
        {
            lock (SoftDollarTiersLock)
            {
                if (SoftDollarTiersSubscribersLookup != null)
                {
                    ...
                    {
                        action.BeginInvoke(Wrapper, new SoftDollarTiersArgs(reqId, tiers), null, null);
                    }
                }
            }
        }
