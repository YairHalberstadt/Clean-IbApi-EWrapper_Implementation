...
namespace EWrapperImpl
{
    public class IBRequester
    {
        ...
        /// <summary>
        /// getting NextOrderId automatically increments it by 1.
        /// </summary>
        ...
        /// to the order ID of a previous order an error will occur. If the orderId does not match that of the Order.OrderId, the Order.OrderId
        /// will be replaced by the orderId</param>
        ...
        /// <param name="duration">the period of time for which the data needs to be retrieved eg. Duration.TwoMonths.
        /// There is a minimum and maximum duration available for each candleSize, and so it is possible the duration of bars returned 
        /// will not match the duration requested.</param>
        /// <param name="candleSize">the size of each bar recieved eg. CandleSize.FifteenMinutes</param>
        ...
        /// <param name="useRegularTradingHours">false to obtain the data which was also generated outside of the Regular Trading Hours, true to obtain only the RTH data</param>
